...
export const tagClick = (tag: ContentsTag) => ({type: TagClickAction, payload: {tag}});
...
export const appReducer: React.Reducer<AppState, AppAction> = (state = appInitialState, actions) =>
{
  switch (actions.type) {
    case TagClickAction:
      return {
